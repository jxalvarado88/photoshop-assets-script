...
function resizeDoc(document, scale) {
	...
	if(scale === 'xxxhdpi') {
		newHeight = Math.floor(calcHeight*1.1596);
		newWidth = Math.floor(calcWidth*1.1596);
	}else if(scale === 'xxhdpi') {
		newHeight = Math.floor(calcHeight*.8697);
		newWidth = Math.floor(calcWidth*.8697);
	} else if(scale === 'xhdpi') {
		newHeight = Math.floor(calcHeight*.5798);
		newWidth = Math.floor(calcWidth*.5798);
	} else if(scale === 'hdpi') {
		newHeight = Math.floor(calcHeight*.43485);
		newWidth = Math.floor(calcWidth*.43485);
	} else if(scale === 'mdpi') {
		newHeight = Math.floor(calcHeight*.2899);
		newWidth = Math.floor(calcWidth*.2899);	
	}
